...
const hotkeyLabels: Record<HotkeyAction, string> = {
  "app.zoom_in": "放大",
  "app.zoom_out": "缩小",
  "app.zoom_reset": "恢复实际大小",
  "command_palette.toggle": "切换命令面板",
  "cookies_editor.show": "显示 Cookies",
  "editor.autocomplete": "触发自动补全",
  "environment_editor.toggle": "编辑环境变量",
  "hotkeys.showHelp": "显示快捷键帮助",
  "model.create": "新建请求",
  "model.duplicate": "复制请求",
  "request.rename": "重命名当前请求",
  "request.send": "发送当前请求",
  "switcher.next": "切换到上一个请求",
  "switcher.prev": "切换到下一个请求",
  "switcher.toggle": "切换请求切换器",
  "settings.show": "打开设置",
  "sidebar.filter": "筛选侧边栏",
  "sidebar.expand_all": "展开所有文件夹",
  "sidebar.collapse_all": "折叠所有文件夹",
  "sidebar.selected.delete": "删除选中的侧边栏项目",
  "sidebar.selected.duplicate": "复制选中的侧边栏项目",
  "sidebar.selected.move": "将选中项移动到工作区",
  "sidebar.selected.rename": "重命名选中的侧边栏项目",
  "sidebar.focus": "聚焦或切换侧边栏",
  "sidebar.context_menu": "显示上下文菜单",
  "url_bar.focus": "聚焦 URL 输入框",
